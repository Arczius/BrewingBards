...
class createCharacterController extends BaseController{
    ...
    public function createCharacter()
    {
        ...
        $this->getCharactersModel->insert(["UserId" => rememberUser()["ID"], "CharacterName" => $this->request->getPost("name"), "CharacterRace" => $this->request->getPost("race"), "CharacterClass" => $this->request->getPost("class")]);
