    ...
    <div class="table--special table--rounded">
        ...
        ?>
            <div class="table__item">
                ...
                <a class="table__item__col link-item txt_right col-1" href="<?php echo base_url() . '/editModerator/' . $moderator['ID'];?>">Aanpassen</a>
                <a class="table__item__col link-item txt_right col-1" href="<?php echo base_url() . '/deleteModerator/' . $moderator['ID'];?>">Verwijder</a>
            </div>
        <?php
        } ?>
