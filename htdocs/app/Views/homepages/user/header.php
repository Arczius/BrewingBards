<header class="block--info">
    <h3>Welkom <?php echo $user['Name'] ?></h3>
    <p class="half-block">Ingelogd als Gebruiker</p><a class="float-right rev" href="<?php echo base_url(); ?>/logout">Uitloggen</a>
    <br> <br>
    <a class="rev" href="<?php echo base_url(); ?>/ChangePassword" ><i class='bx bx-left-arrow'></i>Wachtwoord veranderen</a><br>
