  ...
  <body>
    ...
    <div class=" block">
        <div class="col-5 centered"> 
            <p>Voer je mailadress in zodat je een mail kan ontvangen met een link die je een nieuw wachtwoord zal genereren</p>       
            <form class="form--main" action="<?php echo base_url(); ?>/ForgotPasswordController/sendForgotPasswordNotificationMail" method="post">
