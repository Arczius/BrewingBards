...
$routes->get('/StudentEdit/(:alphanum)','AllStudentFeaturesController::indexStudentEdit/$1');
$routes->match(['get', 'post'], 'AllStudentFeaturesController/UpdatenUsers', 'AllStudentFeaturesController::UpdatenUsers');
